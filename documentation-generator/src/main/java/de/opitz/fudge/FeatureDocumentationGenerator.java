...
import de.opitz.fudge.cli.CommandLineOptions;
import de.opitz.fudge.cli.OptionHandler;
import de.opitz.fudge.cli.ProgramConfiguration;
import de.opitz.fudge.generation.DocumentationGenerator;
import de.opitz.fudge.generation.DocumentationParameters;
...
public class FeatureDocumentationGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            var constructors = new Reflections("de.opitz.fudge.cli")
